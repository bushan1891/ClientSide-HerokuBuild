	...
	return (
		<div className={styles.instructionContainer}>
			...
			<div className={styles.iframe}>
				<iframe src="https://jcsconsultingdemo.app.box.com/embed/s/jmlb96y0euypgrzze5cxxz29b4twyjcd" width="1100" height="550" frameborder="0" allowfullscreen webkitallowfullscreen msallowfullscreen></iframe>
